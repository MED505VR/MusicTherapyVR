...
public class FastList<T>
{
    ...
    {
        if (array == null || size == array.Length) Allocate();
        array[size] = item;
        size++;
    }
    ...
    public void Insert(int index, T item)
    {
        ...
        {
            //move things back 1
            for (var i = size; i > index; i--) array[i] = array[i - 1];
            array[index] = item;
            size++;
        }
        else
        ...
        if (array != null)
            for (var i = 0; i < size; i++)
                if (item.Equals(array[i]))
                {
                    ...
                    size--;
                    for (var j = i; j < size; j++) array[j] = array[j + 1];
                    array[size] = default;
                    return true;
                }
    ...
    public void RemoveAt(int index)
    {
        ...
        {
            size--;
            for (var i = index; i < size; i++) array[i] = array[i + 1];
            array[size] = default;
        }
    }
    ...
    private void Allocate()
    {
        ...
        if (array != null && size > 0) array.CopyTo(newArray, 0);
    ...
    private void Trim()
    {
        if (size > 0)
        {
            ...
            for (var i = 0; i < size; i++) newArray[i] = array[i];
            array = newArray;
        }
        else
        {
