...
*/
    ...
    public class OSPPropsPropertyDrawer : PropertyDrawer
    {
        ...
        private static float indent = 32.0f;

        // TODO - some day just enumerate these
        private static string[] props = new string[]
            { "useFastOverride", "gain", "enableInvSquare", "volumetric", "invSquareFalloff" };

        private static string[] names = new string[]
            { "Reflections Enabled", "Gain", "Enable Oculus Atten.", "Volumetric", "Range" };

        private static int[] lines = new int[] { 1, 1, 1, 1, 2, 2 };
        ...
        */
        ...
        {
            var playSpatializedProp = prop.FindPropertyRelative("enableSpatialization");
            ...
            if (playSpatializedProp.boolValue)
            {
                ...
                for (var i = 0; i < props.Length; i++)
                {
                    ...
                    var sibling = prop.FindPropertyRelative(props[i]);
