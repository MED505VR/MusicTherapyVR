...
*/
    ...
    {
        private static GUIStyle disabledStyle = null;
        ...
        */
        public override void OnGUI(Rect position, SerializedProperty prop, GUIContent label)
        {
            ...
            var nameProp = prop.FindPropertyRelative("soundFXName");
            ...
            {
                var soundFXNames = AudioManager.GetSoundFXNames(nameProp.stringValue, out idx);
                ...
                if (GUI.Button(buttonPosition, "\u2630")) Selection.activeGameObject = AudioManager.GetGameObject();
            }
        }
    }
} // namespace OVR