...
*/
    public class AmbienceEmitter : MonoBehaviour
    {
        ...
        [MinMax(2.0f, 4.0f, 0.1f, 10.0f)] public Vector2 randomRetriggerDelaySecs = new Vector2(2.0f, 4.0f);

        [Tooltip(
            "If defined, the sounds will randomly play from these transform positions, otherwise the sound will play from this transform")]
        ...
        private void Update()
        {
            if (activated)
                if (playingIdx == -1 || autoRetrigger)
                    ...
                    {
                        Play();
                        if (!autoRetrigger) activated = false;
                    }
        }
        ...
        */
        public void Play()
        {
            ...
            if (playPositions.Length > 0)
            {
                ...
                while (playPositions.Length > 1 && idx == lastPosIdx) idx = Random.Range(0, playPositions.Length);
        ...
        */
        public void EnableEmitter(bool enable)
        {
            ...
            {
                if (playingIdx != -1) AudioManager.FadeOutSound(playingIdx, fadeTime);
            }
        }
    }
} // namespace OVR