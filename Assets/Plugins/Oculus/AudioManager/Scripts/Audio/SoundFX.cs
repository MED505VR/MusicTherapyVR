...
namespace OVR
{
    ...
    public class OSPProps
    {
        ...
        [Tooltip("Boost the gain on the spatialized sound FX, default = 0.0")] [Range(0.0f, 24.0f)]
...
*/
    ...
    public class SoundFX
    {
        ...
        [Tooltip("Default volume for this sound FX, default = 1.0")] [Range(0.0f, 1.0f)]
        ...
        [Tooltip("Falloff distance for the sound FX, default = 1m min to 25m max")] [MinMax(1.0f, 25.0f, 0.0f, 250.0f)]
        ...
        [Tooltip(
            "The amount by which the signal from the AudioSource will be mixed into the global reverb associated with the Reverb Zones | Valid range is 0.0 - 1.1, default = 1.0")]
        public AnimationCurve reverbZoneMix =
            new AnimationCurve(new Keyframe[2] { new Keyframe(0f, 1.0f), new Keyframe(1f, 1f) });

        [Tooltip(
            "Sets the spread angle (in degrees) of a 3d stereo or multichannel sound in speaker space, default = 0")]
        [Range(0.0f, 360.0f)]
        ...
        [Tooltip(
            "Sets the priority for this sound to play and/or to override a currently playing sound FX, default = Default")]
        ...
        // runtime vars
        [System.NonSerialized] private SoundGroup soundGroup = null;
        ...
        */
        public AudioClip GetClip()
        {
            ...
            {
                // sequential
                if (++lastIdx >= soundClips.Length) lastIdx = 0;
        ...
        */
        ...
        {
            if (soundGroup != null) return soundGroup.mixerGroup != null ? soundGroup.mixerGroup : defaultMixerGroup;
        ...
        */
        ...
        {
            if (soundGroup != null) return !soundGroup.CanPlaySound();
            return false;
        }
        ...
        */
        ...
        -----------------------
        */
        public int PlaySoundAt(Vector3 pos, float delaySecs = 0.0f, float volumeOverride = 1.0f,
            float pitchMultiplier = 1.0f)
        {
            ...
            {
                if (delay.y > 0.0f) delaySecs = Random.Range(delay.x, delay.y);
                playingIdx = AudioManager.PlaySoundAt(pos, this, EmitterChannel.Any, delaySecs, volumeOverride,
                    pitchMultiplier);
            }
        ...
        */
        ...
        {
            if (playingIdx > -1) AudioManager.SetOnFinished(playingIdx, onFinished);
        }
        ...
        */
        ...
        {
            if (playingIdx > -1) AudioManager.SetOnFinished(playingIdx, onFinished, obj);
        }
        ...
        */
        ...
        {
            if (playingIdx > -1) AudioManager.AttachSoundToParent(playingIdx, parent);
        }
        ...
        */
        ...
        {
            if (playingIdx > -1) AudioManager.DetachSoundFromParent(playingIdx);
        }
    }
} // namespace OVR