    ...
    OVRMeshRenderer.IOVRMeshRendererDataProvider
{
    ...
    [SerializeField] private Hand HandType = Hand.None;
    [SerializeField] private Transform _pointerPoseRoot = null;
    ...
    private void Awake()
    {
        ...
        if (_pointerPoseRoot != null) PointerPose.SetParent(_pointerPoseRoot, false);
    ...
    {
        if (OVRPlugin.nativeXrApi != OVRPlugin.XrApi.OpenXR) GetHandState(OVRPlugin.Step.Physics);
    }
