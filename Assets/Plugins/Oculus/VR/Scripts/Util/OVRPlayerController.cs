...
public class OVRPlayerController : MonoBehaviour
{
    ...
    private void OnDisable()
    {
        if (playerControllerEnabled)
        {
            ...
            if (CameraRig != null) CameraRig.UpdatedAnchors -= UpdateTransform;
    ...
    protected virtual void UpdateController()
    {
        ...
        if (Controller.isGrounded && MoveThrottle.y <= transform.lossyScale.y * 0.001f)
        {
            ...
            var bumpUpOffset = Mathf.Max(Controller.stepOffset,
        ...
        if (EnableRotation)
        {
            ...
            else
            {
                ...
                if (RotationEitherThumbstick)
                {
                    ...
                    if (secondaryAxis.sqrMagnitude < altSecondaryAxis.sqrMagnitude) secondaryAxis = altSecondaryAxis;
                }
    ...
    public void UpdateTransform(OVRCameraRig rig)
    {
        ...
        UpdateController();
        if (TransformUpdated != null) TransformUpdated(root);
    }
