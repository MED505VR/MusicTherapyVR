...
public static class OVRPlugin
{
...
#else
    public static readonly Version wrapperVersion = OVRP_1_57_0.version;
#endif
    ...
    public static XrApi nativeXrApi
    {
        get
        {
            ...
            if (!_nativeXrApi.HasValue)
            {
                ...
                {
                    XrApi xrApi;
                    if (OVRP_1_55_0.ovrp_GetNativeXrApiType(out xrApi) == Result.Success) _nativeXrApi = xrApi;
                }
            }
    ...
    public static bool chromatic
    {
        get
        {
            ...
            if (version >= OVRP_1_7_0.version)
                return initialized && OVRP_1_7_0.ovrp_GetAppChromaticCorrection() == Bool.True;
    ...
    public static bool monoscopic
    {
        get
        {
			...
			return false;
#else
            return initialized && OVRP_1_1_0.ovrp_GetAppMonoscopic() == Bool.True;
#endif
        }
        set
        {
			...
			return;
#else
            if (initialized) OVRP_1_1_0.ovrp_SetAppMonoscopic(ToBool(value));
#endif
        }
    }
    ...
    public static bool rotation
    {
        ...
        set
        {
			...
			return;
#else
            if (initialized) OVRP_1_1_0.ovrp_SetTrackingOrientationEnabled(ToBool(value));
#endif
        }
    }
    ...
    public static bool position
    {
        ...
        set
        {
			...
			return;
#else
            if (initialized) OVRP_1_1_0.ovrp_SetTrackingPositionEnabled(ToBool(value));
#endif
        }
    }
    ...
    public static bool headphonesPresent
    {
        get
        {
			...
			return false;
#else
            return initialized && OVRP_1_3_0.ovrp_GetSystemHeadphonesPresent() == Bool.True;
#endif
        }
    }
    ...
    public static bool EnqueueSubmitLayer(bool onTop, bool headLocked, bool noDepthBufferTesting, IntPtr leftTexture,
        ...
        bool overrideTextureRectMatrix = false, TextureRectMatrixf textureRectMatrix = default,
        bool overridePerLayerColorScaleAndOffset = false, Vector4 colorScale = default, Vector4 colorOffset = default,
    ...
    public static PoseStatef GetNodePoseStateRaw(Node nodeId, Step stepId)
    {
        ...
        if (version >= OVRP_1_29_0.version)
        {
            ...
            var result = OVRP_1_29_0.ovrp_GetNodePoseStateRaw(stepId, -1, nodeId, out nodePoseState);
    ...
    public static Posef GetCurrentTrackingTransformPose()
    {
        ...
        if (version >= OVRP_1_30_0.version)
        {
            ...
            var result = OVRP_1_30_0.ovrp_GetCurrentTrackingTransformPose(out trackingTransformPose);
            if (result == Result.Success)
    ...
    public static Posef GetTrackingTransformRawPose()
    {
        ...
        if (version >= OVRP_1_30_0.version)
        {
            ...
            var result = OVRP_1_30_0.ovrp_GetTrackingTransformRawPose(out trackingTransforRawPose);
            if (result == Result.Success)
...
#else
        if (version >= OVRP_1_12_0.version) return OVRP_1_12_0.ovrp_GetControllerState2(controllerMask);
    ...
    public static double GetHandNodePoseStateLatency()
    {
        ...
        {
            var value = 0.0;
            if (OVRP_1_18_0.ovrp_GetHandNodePoseStateLatency(out value) == Result.Success)
                return value;
            else
                return 0.0;
        }
...
#endif
        {
            var result = OVRP_1_15_0.ovrp_InitializeMixedReality();
            if (result != Result.Success)
            {
...
#endif
        {
            var result = OVRP_1_15_0.ovrp_ShutdownMixedReality();
            if (result != Result.Success)
            {
    ...
    public static int GetExternalCameraCount()
    {
        ...
        {
            var cameraCount = 0;
            var result = OVRP_1_15_0.ovrp_GetExternalCameraCount(out cameraCount);
            if (result != Result.Success)
        ...
        if (version >= OVRP_1_44_0.version)
        {
            ...
            var result =
                OVRP_1_44_0.ovrp_OverrideExternalCameraFov(cameraId, useOverriddenFov ? Bool.True : Bool.False,
                    ref fov);
            if (result != Result.Success) retValue = false;
            return retValue;
        }
        else
        {
    ...
    public static bool GetUseOverriddenExternalCameraFov(int cameraId)
    {
        ...
        if (version >= OVRP_1_44_0.version)
        {
            ...
            if (result != Result.Success) retValue = false;
            if (useOverriddenFov == Bool.False) retValue = false;
            return retValue;
        }
        else
        {
    ...
    public static bool OverrideExternalCameraStaticPose(int cameraId, bool useOverriddenPose, Posef poseInStageOrigin)
    {
        ...
        {
            var retValue = true;
            var result = OVRP_1_44_0.ovrp_OverrideExternalCameraStaticPose(cameraId,
    ...
    public static bool GetUseOverriddenExternalCameraStaticPose(int cameraId)
    {
        ...
        if (version >= OVRP_1_44_0.version)
        {
            ...
            if (result != Result.Success) retValue = false;
            if (useOverriddenStaticPose == Bool.False) retValue = false;
            return retValue;
        }
        else
        {
    ...
    public static bool UpdateCameraDevices()
    {
        ...
        if (version >= OVRP_1_16_0.version)
        {
            var result = OVRP_1_16_0.ovrp_UpdateCameraDevices();
            if (result != Result.Success)
            {
    ...
    public static bool IsCameraDeviceAvailable(CameraDevice cameraDevice)
    {
        ...
        if (version >= OVRP_1_16_0.version)
        {
            var result = OVRP_1_16_0.ovrp_IsCameraDeviceAvailable(cameraDevice);
    ...
    public static bool SetCameraDevicePreferredColorFrameSize(CameraDevice cameraDevice, int width, int height)
    {
        ...
        if (version >= OVRP_1_16_0.version)
        {
            ...
            size.w = width;
            size.h = height;
            var result = OVRP_1_16_0.ovrp_SetCameraDevicePreferredColorFrameSize(cameraDevice, size);
            if (result != Result.Success)
            {
    ...
    public static bool OpenCameraDevice(CameraDevice cameraDevice)
    {
        ...
        if (version >= OVRP_1_16_0.version)
        {
            var result = OVRP_1_16_0.ovrp_OpenCameraDevice(cameraDevice);
            if (result != Result.Success)
            {
    ...
    public static bool CloseCameraDevice(CameraDevice cameraDevice)
    {
        ...
        if (version >= OVRP_1_16_0.version)
        {
            var result = OVRP_1_16_0.ovrp_CloseCameraDevice(cameraDevice);
            if (result != Result.Success)
            {
                //Debug.LogWarning("ovrp_OpenCameraDevice return " + result);
            }
    ...
    public static bool HasCameraDeviceOpened(CameraDevice cameraDevice)
    {
        ...
        if (version >= OVRP_1_16_0.version)
        {
            var result = OVRP_1_16_0.ovrp_HasCameraDeviceOpened(cameraDevice);
            return result == Bool.True;
        }
        else
        {
    ...
    public static bool IsCameraDeviceColorFrameAvailable(CameraDevice cameraDevice)
    {
        ...
        if (version >= OVRP_1_16_0.version)
        {
            var result = OVRP_1_16_0.ovrp_IsCameraDeviceColorFrameAvailable(cameraDevice);
            return result == Bool.True;
        }
        else
        {
    ...
    public static Texture2D GetCameraDeviceColorFrameTexture(CameraDevice cameraDevice)
    {
        ...
        {
            var size = new Sizei();
            var result = OVRP_1_16_0.ovrp_GetCameraDeviceColorFrameSize(cameraDevice, out size);
            if (result != Result.Success)
    ...
    public static bool DoesCameraDeviceSupportDepth(CameraDevice cameraDevice)
    {
        ...
        {
            Bool supportDepth;
            var result = OVRP_1_17_0.ovrp_DoesCameraDeviceSupportDepth(cameraDevice, out supportDepth);
        ...
        CameraDeviceDepthSensingMode depthSensoringMode)
    {
        ...
        if (version >= OVRP_1_17_0.version)
        {
            var result = OVRP_1_17_0.ovrp_SetCameraDeviceDepthSensingMode(camera, depthSensoringMode);
            return result == Result.Success;
        }
        else
        {
    ...
    public static bool SetCameraDevicePreferredDepthQuality(CameraDevice camera, CameraDeviceDepthQuality depthQuality)
    {
        ...
        if (version >= OVRP_1_17_0.version)
        {
            var result = OVRP_1_17_0.ovrp_SetCameraDevicePreferredDepthQuality(camera, depthQuality);
            return result == Result.Success;
        }
        else
        {
    ...
    public static bool IsCameraDeviceDepthFrameAvailable(CameraDevice cameraDevice)
    {
        ...
        {
            Bool available;
            var result = OVRP_1_17_0.ovrp_IsCameraDeviceDepthFrameAvailable(cameraDevice, out available);
    ...
    public static Texture2D GetCameraDeviceDepthFrameTexture(CameraDevice cameraDevice)
    {
        ...
        {
            var size = new Sizei();
            var result = OVRP_1_17_0.ovrp_GetCameraDeviceDepthFrameSize(cameraDevice, out size);
            if (result != Result.Success)
    ...
    public static bool fixedFoveatedRenderingSupported
    {
        get
        {
            ...
            {
                Bool supported;
                var result = OVRP_1_21_0.ovrp_GetTiledMultiResSupported(out supported);
                if (result == Result.Success)
    ...
    public static FixedFoveatedRenderingLevel fixedFoveatedRenderingLevel
    {
        get
        {
            ...
            if (version >= OVRP_1_21_0.version && fixedFoveatedRenderingSupported)
            {
                ...
                var result = OVRP_1_21_0.ovrp_GetTiledMultiResLevel(out level);
                if (result != Result.Success)
                {
    ...
    public static bool useDynamicFixedFoveatedRendering
    {
        get
        {
            ...
            if (version >= OVRP_1_46_0.version && fixedFoveatedRenderingSupported)
            {
                ...
                var result = OVRP_1_46_0.ovrp_GetTiledMultiResDynamic(out isDynamic);
                if (result != Result.Success)
                {
        ...
        set
        {
            ...
            if (version >= OVRP_1_46_0.version && fixedFoveatedRenderingSupported)
            {
                var result = OVRP_1_46_0.ovrp_SetTiledMultiResDynamic(value ? Bool.True : Bool.False);
                if (result != Result.Success)
                {
    ...
    {
        get => (TiledMultiResLevel)fixedFoveatedRenderingLevel;
    ...
    public static bool gpuUtilSupported
    {
        get
        {
            ...
            {
                Bool supported;
                var result = OVRP_1_21_0.ovrp_GetGPUUtilSupported(out supported);
                if (result == Result.Success)
                    return supported == Bool.True;
                else
    ...
    public static float gpuUtilLevel
    {
        get
        {
            ...
            {
                float level;
                var result = OVRP_1_21_0.ovrp_GetGPUUtilLevel(out level);
                if (result == Result.Success)
                    return level;
                else
    ...
    public static float systemDisplayFrequency
    {
        get
        {
            ...
            if (version >= OVRP_1_21_0.version)
            {
                ...
                var result = OVRP_1_21_0.ovrp_GetSystemDisplayFrequency2(out displayFrequency);
                if (result == Result.Success) return displayFrequency;
        ...
        set
        {
			...
			return;
#else
            if (version >= OVRP_1_21_0.version) OVRP_1_21_0.ovrp_SetSystemDisplayFrequency(value);
#endif
        }
    }
    ...
    public static bool eyeFovPremultipliedAlphaModeEnabled
    {
        get
        {
            ...
            if (version >= OVRP_1_57_0.version) OVRP_1_57_0.ovrp_GetEyeFovPremultipliedAlphaMode(ref isEnabled);
        ...
        set
        {
			...
			return;
#else
            if (version >= OVRP_1_57_0.version) OVRP_1_57_0.ovrp_SetEyeFovPremultipliedAlphaMode(ToBool(value));
#endif
        }
    }
    ...
    public static bool IsPerfMetricsSupported(PerfMetrics perfMetrics)
    {
        ...
        {
            Bool isSupported;
            var result = OVRP_1_30_0.ovrp_IsPerfMetricsSupported(perfMetrics, out isSupported);
            if (result == Result.Success)
    ...
    public static float? GetPerfMetricsFloat(PerfMetrics perfMetrics)
    {
        ...
        {
            float value;
            var result = OVRP_1_30_0.ovrp_GetPerfMetricsFloat(perfMetrics, out value);
            if (result == Result.Success)
                return value;
            else
                return null;
    ...
    public static int? GetPerfMetricsInt(PerfMetrics perfMetrics)
    {
        ...
        {
            int value;
            var result = OVRP_1_30_0.ovrp_GetPerfMetricsInt(perfMetrics, out value);
            if (result == Result.Success)
                return value;
            else
                return null;
    ...
    public static double GetTimeInSeconds()
    {
        ...
        {
            double value;
            var result = OVRP_1_31_0.ovrp_GetTimeInSeconds(out value);
            if (result == Result.Success)
                return value;
            else
                return 0.0;
    ...
    public class Media
    {
        ...
        public static bool GetInitialized()
        {
            ...
            if (version >= OVRP_1_38_0.version)
            {
                ...
                var result = OVRP_1_38_0.ovrp_Media_GetInitialized(out initialized);
                if (result == Result.Success)
        ...
        public static InputVideoBufferType GetMrcInputVideoBufferType()
        {
            ...
            if (version >= OVRP_1_38_0.version)
            {
                var videoBufferType = InputVideoBufferType.Memory;
        ...
        public static void GetMrcFrameSize(out int frameWidth, out int frameHeight)
        {
            ...
            frameHeight = -1;
#if !OVRPLUGIN_UNSUPPORTED_PLATFORM
            if (version >= OVRP_1_38_0.version) OVRP_1_38_0.ovrp_Media_GetMrcFrameSize(ref frameWidth, ref frameHeight);
#endif
        }
...
#else
            var sampleRate = 0;
            if (version >= OVRP_1_38_0.version) OVRP_1_38_0.ovrp_Media_GetMrcAudioSampleRate(ref sampleRate);
            return sampleRate;
#endif
        }
        ...
        public static bool SetMrcFrameImageFlipped(bool imageFlipped)
        {
            ...
            if (version >= OVRP_1_38_0.version)
            {
                var flipped = imageFlipped ? Bool.True : Bool.False;
...
#else
            Bool flipped = 0;
            if (version >= OVRP_1_38_0.version) OVRP_1_38_0.ovrp_Media_GetMrcFrameImageFlipped(ref flipped);
            return flipped == Bool.True ? true : false;
#endif
        }

        public static bool EncodeMrcFrame(IntPtr textureHandle, IntPtr fgTextureHandle, float[] audioData,
            int audioFrames, int audioChannels, double timestamp, double poseTime, ref int outSyncId)
        {
            ...
            if (version >= OVRP_1_38_0.version)
            {
                ...
                var videoBufferType = GetMrcInputVideoBufferType();
                ...
                var pinnedAudioData = new GCHandle();
                ...
                if (audioData != null) pinnedAudioData.Free();
                return result == Result.Success;
            }
            else
            {
            ...
            double timestamp, double poseTime, ref int outSyncId)
        {
            ...
            if (version >= OVRP_1_38_0.version)
            {
                ...
                var bytes = cachedTexture.GetPixels32(0);
		...
		return false;
            ...
            if (version >= OVRP_1_49_0.version)
            {
                var res = OVRP_1_49_0.ovrp_Media_SetHeadsetControllerPose(headsetPose, leftControllerPose,
                    rightControllerPose);
    ...
    public static bool GetHandTrackingEnabled()
    {
        ...
        if (version >= OVRP_1_44_0.version)
        {
            ...
            if (res == Result.Success) return val == Bool.True;
    ...
    public static bool GetSkeleton2(SkeletonType skeletonType, ref Skeleton2 skeleton)
    {
        ...
        if (version >= OVRP_1_55_0.version)
        {
            var res = OVRP_1_55_0.ovrp_GetSkeleton2(skeletonType, out cachedSkeleton2);
            if (res == Result.Success)
            {
        ...
        else
        {
            if (GetSkeleton(skeletonType, out cachedSkeleton))
            {
                ...
                for (var i = 0; i < skeleton.NumBones; i++) skeleton.Bones[i] = cachedSkeleton.Bones[i];

                for (var i = 0; i < skeleton.NumBoneCapsules; i++)
    ...
    public static bool GetMesh(MeshType meshType, out Mesh mesh)
    {
        ...
        if (version >= OVRP_1_44_0.version)
        {
            ...
            if (result == Result.Success) Marshal.PtrToStructure(meshPtr, mesh);
    ...
    public static int GetLocalTrackingSpaceRecenterCount()
    {
        ...
        {
            var recenterCount = 0;
            var res = OVRP_1_44_0.ovrp_GetLocalTrackingSpaceRecenterCount(ref recenterCount);
            if (res == Result.Success) return recenterCount;
    ...
    public static ColorSpace GetHmdColorDesc()
    {
        ...
        if (version >= OVRP_1_49_0.version)
        {
            var res = OVRP_1_49_0.ovrp_GetHmdColorDesc(ref colorSpace);
            if (res != Result.Success) Debug.LogError("GetHmdColorDesc: Failed to get Hmd color description");
            return colorSpace;
        }
        else
        {
    ...
    public static bool PollEvent(ref EventDataBuffer eventDataBuffer)
    {
        ...
        if (version >= OVRP_1_55_1.version)
        {
            ...
            if (eventDataBuffer.EventData == null) eventDataBuffer.EventData = new byte[EventDataBufferSize];
            var result = OVRP_1_55_1.ovrp_PollEvent2(ref eventDataBuffer.EventType, ref DataPtr);
    ...
    public static ulong GetNativeOpenXRInstance()
    {
        ...
        if (version >= OVRP_1_55_0.version)
        {
            ulong instance, session;
            if (OVRP_1_55_0.ovrp_GetNativeOpenXRHandles(out instance, out session) == Result.Success) return instance;
        }
    ...
    public static ulong GetNativeOpenXRSession()
    {
        ...
        {
            ulong instance, session;
            if (OVRP_1_55_0.ovrp_GetNativeOpenXRHandles(out instance, out session) == Result.Success) return session;
        }
    ...
    public static bool SetKeyboardOverlayUV(Vector2f uv)
    {
        ...
        if (version >= OVRP_1_57_0.version)
        {
            var result = OVRP_1_57_0.ovrp_SetKeyboardOverlayUV(uv);
            return result == Result.Success;
        }
        else
        {
    ...
    private static class OVRP_1_15_0
    {
        ...
        public static extern Result ovrp_GetExternalCameraName(int cameraId,
            [MarshalAs(UnmanagedType.LPArray, SizeConst = OVRP_EXTERNAL_CAMERA_NAME_SIZE)] char[] cameraName);
    ...
    private static class OVRP_1_38_0
    {
        ...
        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_Media_EncodeMrcFrame(IntPtr rawBuffer, IntPtr audioDataPtr, int audioDataLen,
            int audioChannels, double timestamp, ref int outSyncId);

        [DllImport(pluginName, CallingConvention = CallingConvention.Cdecl)]
        public static extern Result ovrp_Media_EncodeMrcFrameWithDualTextures(IntPtr backgroundTextureHandle,
