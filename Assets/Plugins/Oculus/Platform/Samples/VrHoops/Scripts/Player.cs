    ...
    public abstract class Player : MonoBehaviour
    {
        ...
        public virtual uint Score
        {
            ...
            set
            {
                ...
                if (m_scoreUI) m_scoreUI.text = m_score.ToString();
            }
        }
        ...
        {
            if (m_balls.Count >= MAX_BALLS) Destroy(m_balls.Dequeue());
        ...
        protected GameObject ShootBall()
        {
            ...
            ball.GetComponent<Rigidbody>()
                .AddForce(m_ballEjector.transform.forward * INITIAL_FORCE, ForceMode.Acceleration);
        ...
        {
            foreach (var ball in m_balls) Destroy(ball);
        }
    }
}