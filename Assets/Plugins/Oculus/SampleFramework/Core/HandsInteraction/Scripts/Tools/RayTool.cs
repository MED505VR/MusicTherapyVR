...
namespace OculusSampleFramework
{
    ...
    public class RayTool : InteractableTool
    {
        ...
        public override ToolInputState ToolInputState
        {
            get
            {
                if (_pinchStateModule.PinchDownOnFocusedObject) return ToolInputState.PrimaryInputDown;
                if (_pinchStateModule.PinchSteadyOnFocusedObject) return ToolInputState.PrimaryInputDownStay;
                if (_pinchStateModule.PinchUpAndDownOnFocusedObject) return ToolInputState.PrimaryInputUp;
        ...
        private void Update()
        {
            if (!HandsManager.Instance || !HandsManager.Instance.IsInitialized() || !_initialized) return;
        ...
        {
            if (!_initialized) return _currentIntersectingObjects;
            ...
            if (_currInteractableCastedAgainst == null)
            {
                ...
                if (_currInteractableCastedAgainst != null)
                {
                    ...
                    if (_currentIntersectingObjects.Count == 0) _currInteractableCastedAgainst = null;
                }
            }
        ...
        private Interactable FindTargetInteractable()
        {
            ...
            if (targetInteractable == null) targetInteractable = FindInteractableViaConeTest(rayOrigin, rayDirection);
        ...
        private Interactable FindPrimaryRaycastHit(Vector3 rayOrigin, Vector3 rayDirection)
        {
            ...
            for (var hitIndex = 0; hitIndex < numHits; hitIndex++)
            {
                ...
                if (currentInteractable == null ||
                    (currentInteractable.ValidToolTagsMask & (int)ToolTags) == 0) continue;
        ...
        private Interactable FindInteractableViaConeTest(Vector3 rayOrigin, Vector3 rayDirection)
        {
            ...
            for (var i = 0; i < numColliders; i++)
            {
                ...
                // must be inside cone!
                if (dotProduct < minDotProductThreshold) continue;
