...
namespace OculusSampleFramework
{
    ...
    public class PinchStateModule
    {
        ...
        public bool PinchUpAndDownOnFocusedObject =>
            _currPinchState == PinchState.PinchUp && _firstFocusedInteractable != null;

        public bool PinchSteadyOnFocusedObject =>
            _currPinchState == PinchState.PinchStay && _firstFocusedInteractable != null;

        public bool PinchDownOnFocusedObject =>
            _currPinchState == PinchState.PinchDown && _firstFocusedInteractable != null;
            ...
            switch (oldPinchState)
            {
                case PinchState.PinchUp:
                    ...
                    if (isPinching)
                    {
                        ...
                        if (currFocusedInteractable != _firstFocusedInteractable) _firstFocusedInteractable = null;
                    }
                    else
                    {
                        _currPinchState = PinchState.None;
                ...
                case PinchState.PinchStay:
                    if (!isPinching) _currPinchState = PinchState.PinchUp;
                ...
                case PinchState.PinchDown:
                    ...
                    if (_firstFocusedInteractable != currFocusedInteractable) _firstFocusedInteractable = null;
                    break;
                default:
                    if (isPinching)
                    {
