...
namespace OculusSampleFramework
{
    ...
    public class FingerTipPokeTool : InteractableTool
    {
        ...
        {
            while (!HandsManager.Instance || !HandsManager.Instance.IsInitialized()) yield return null;

            var handSkeleton = IsRightHandedTool
            ...
            if (boneCapsules.Count > 0) _capsuleToTrack = boneCapsules[0];
