...
public class TeleportTransitionBlink : TeleportTransition
{
    ...
    /// </summary>
    [Tooltip("How long the transition takes. Usually this is greater than Teleport Delay.")] [Range(0.01f, 2.0f)]
    public float TransitionDuration = 0.5f;

    /// <summary>
    /// At what percentage of the elapsed transition time does the teleport occur?
    /// </summary>
    [Tooltip("At what percentage of the elapsed transition time does the teleport occur?")] [Range(0.0f, 1.0f)]
