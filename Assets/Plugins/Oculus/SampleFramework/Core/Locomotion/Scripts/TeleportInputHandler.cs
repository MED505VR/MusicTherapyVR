...
public abstract class TeleportInputHandler : TeleportSupport
{
    ...
    {
        if (LocomotionTeleport.InputHandler == this) LocomotionTeleport.InputHandler = null;
        LocomotionTeleport.EnterStateReady -= _startReadyAction;
        LocomotionTeleport.EnterStateAim -= _startAimAction;
    ...
    {
        while (GetIntention() != LocomotionTeleport.TeleportIntentions.Aim) yield return null;
