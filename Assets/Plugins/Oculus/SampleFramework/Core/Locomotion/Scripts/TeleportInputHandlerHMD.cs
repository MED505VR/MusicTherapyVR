...
public class TeleportInputHandlerHMD : TeleportInputHandler
{
    ...
    public override LocomotionTeleport.TeleportIntentions GetIntention()
    {
        ...
        if (OVRInput.Get(AimButton)) return LocomotionTeleport.TeleportIntentions.Aim;
        ...
        if (AimButton == TeleportButton) return LocomotionTeleport.TeleportIntentions.Teleport;
