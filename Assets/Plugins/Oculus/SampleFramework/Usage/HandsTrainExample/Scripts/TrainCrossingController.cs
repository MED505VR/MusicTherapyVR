...
namespace OculusSampleFramework
{
    public class TrainCrossingController : MonoBehaviour
    {
        ...
        {
            if (_lightsSide1Mat != null) Destroy(_lightsSide1Mat);
            if (_lightsSide2Mat != null) Destroy(_lightsSide2Mat);
        }

        public void CrossingButtonStateChanged(InteractableStateArgs obj)
        {
            var inActionState = obj.NewInteractableState == InteractableState.ActionState;
            if (inActionState) ActivateTrainCrossing();
        ...
        private void ActivateTrainCrossing()
        {
            ...
            _audioSource.Play();
            if (_xingAnimationCr != null) StopCoroutine(_xingAnimationCr);
        ...
        {
            foreach (var material in materials) material.SetColor(_colorId, newColor);
        }
