...
namespace Oculus.Platform
{
    ...
    public sealed class Core
    {
            ...
            else
            {
                if (!string.IsNullOrEmpty(configAppID))
                    Debug.LogWarningFormat(
                        "The 'Oculus App Id ({0})' field in 'Oculus Platform/Edit Settings' is being overridden by the App Id ({1}) that you passed in to Platform.Core.Initialize.  You should only specify this in one place.  We recommend the menu location.",
                        configAppID, appId);
            }
        ...
        public static Request<Models.PlatformInitialize> AsyncInitialize(string appId = null)
        {
            ...
            if (!IsPlatformInitialized) throw new UnityException("Oculus Platform failed to initialize.");

            if (LogMessages)
                Debug.LogWarning(
                    "Oculus.Platform.Core.LogMessages is set to true. This will cause extra heap allocations, and should not be used outside of testing and debugging.");
    ...
    public static partial class Rooms
    {
        public static Request<Models.Room> UpdateDataStore(ulong roomID, Dictionary<string, string> data)
        {
            if (Core.IsInitialized())
            {
                ...
                var i = 0;
                foreach (var item in data) kvps[i++] = new CAPI.ovrKeyValuePair(item.Key, item.Value);
    ...
    public static partial class Matchmaking
    {
        public class CustomQuery
        {
            ...
            public IntPtr ToUnmanaged()
            {
                    ...
                    for (var i = 0; i < criteria.Length; i++)
                    {
                        ...
                        if (criteria[i].parameters != null && criteria[i].parameters.Count > 0)
                        {
                            ...
                            temp[i].parameterArray =
                                CAPI.ArrayOfStructsToIntPtr(CAPI.DictionaryToOVRKeyValuePairs(criteria[i].parameters));
                        }
                        else
                        {
                ...
                if (data != null && data.Count > 0)
                {
                    ...
                    customQueryUnmanaged.dataArray =
                        CAPI.ArrayOfStructsToIntPtr(CAPI.DictionaryToOVRKeyValuePairs(data));
                }
                else
                {
        ...
        public static Request<Models.MatchmakingStats> GetStats(string pool, uint maxLevel,
    ...
    public static partial class Net
    {
        public static Packet ReadPacket()
        {
            ...
            if (packetHandle == IntPtr.Zero) return null;
        ...
        {
            if (Core.IsInitialized()) return CAPI.ovr_Net_SendPacket(userID, (UIntPtr)bytes.Length, bytes, policy);
        ...
        {
            if (Core.IsInitialized()) CAPI.ovr_Net_Connect(userID);
        }

        public static void Accept(ulong userID)
        {
            if (Core.IsInitialized()) CAPI.ovr_Net_Accept(userID);
        }

        public static void Close(ulong userID)
        {
            if (Core.IsInitialized()) CAPI.ovr_Net_Close(userID);
        }
        ...
        {
            if (Core.IsInitialized()) return CAPI.ovr_Net_SendPacketToCurrentRoom((UIntPtr)bytes.Length, bytes, policy);
        ...
        {
            if (Core.IsInitialized()) return CAPI.ovr_Net_AcceptForCurrentRoom();
        ...
        public static Request<Models.PingResult> Ping(ulong userID)
        {
            if (Core.IsInitialized()) return new Request<Models.PingResult>(CAPI.ovr_Net_Ping(userID));
    ...
    public static partial class Leaderboards
    {
        ...
        {
            if (Core.IsInitialized())
                return new Request<Models.LeaderboardEntryList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl,
        ...
        {
            if (Core.IsInitialized())
                return new Request<Models.LeaderboardEntryList>(CAPI.ovr_HTTP_GetWithMessageType(list.PreviousUrl,
                    (int)Message.MessageType.Leaderboard_GetPreviousEntries));
    ...
    public static partial class Challenges
    {
        ...
        {
            if (Core.IsInitialized())
                return new Request<Models.ChallengeEntryList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl,
                    (int)Message.MessageType.Challenges_GetNextEntries));
        ...
        {
            if (Core.IsInitialized())
                return new Request<Models.ChallengeEntryList>(CAPI.ovr_HTTP_GetWithMessageType(list.PreviousUrl,
                    (int)Message.MessageType.Challenges_GetPreviousEntries));
        ...
        {
            if (Core.IsInitialized())
                return new Request<Models.ChallengeList>(CAPI.ovr_HTTP_GetWithMessageType(list.NextUrl,
        ...
        {
            if (Core.IsInitialized())
                return new Request<Models.ChallengeList>(CAPI.ovr_HTTP_GetWithMessageType(list.PreviousUrl,
                    (int)Message.MessageType.Challenges_GetPreviousChallenges));
    ...
    public static partial class Voip
    {
        ...
        {
            if (Core.IsInitialized()) CAPI.ovr_Voip_Start(userID);
        }

        public static void Accept(ulong userID)
        {
            if (Core.IsInitialized()) CAPI.ovr_Voip_Accept(userID);
        }

        public static void Stop(ulong userID)
        {
            if (Core.IsInitialized()) CAPI.ovr_Voip_Stop(userID);
        }

        public static void SetMicrophoneFilterCallback(CAPI.FilterCallback callback)
        {
            if (Core.IsInitialized())
                CAPI.ovr_Voip_SetMicrophoneFilterCallbackWithFixedSizeBuffer(callback,
                    (UIntPtr)CAPI.VoipFilterBufferSize);
        }

        public static void SetMicrophoneMuted(VoipMuteState state)
        {
            if (Core.IsInitialized()) CAPI.ovr_Voip_SetMicrophoneMuted(state);
        }

        public static VoipMuteState GetSystemVoipMicrophoneMuted()
        {
            if (Core.IsInitialized()) return CAPI.ovr_Voip_GetSystemVoipMicrophoneMuted();
            return VoipMuteState.Unknown;
        }

        public static SystemVoipStatus GetSystemVoipStatus()
        {
            if (Core.IsInitialized()) return CAPI.ovr_Voip_GetSystemVoipStatus();
            return SystemVoipStatus.Unknown;
        }

        public static VoipDtxState GetIsConnectionUsingDtx(ulong peerID)
        {
            if (Core.IsInitialized()) return CAPI.ovr_Voip_GetIsConnectionUsingDtx(peerID);
            return VoipDtxState.Unknown;
        }

        public static VoipBitrate GetLocalBitrate(ulong peerID)
        {
            if (Core.IsInitialized()) return CAPI.ovr_Voip_GetLocalBitrate(peerID);
            return VoipBitrate.Unknown;
        }

        public static VoipBitrate GetRemoteBitrate(ulong peerID)
        {
            if (Core.IsInitialized()) return CAPI.ovr_Voip_GetRemoteBitrate(peerID);
            return VoipBitrate.Unknown;
        }

        public static void SetNewConnectionOptions(VoipOptions voipOptions)
        {
            if (Core.IsInitialized()) CAPI.ovr_Voip_SetNewConnectionOptions((IntPtr)voipOptions);
        }
    }
    ...
    public static partial class Achievements
    {
        ...
        public static Request<Models.AchievementDefinitionList> GetDefinitionsByName(string[] names)
        {
            if (Core.IsInitialized())
                return new Request<Models.AchievementDefinitionList>(
                    CAPI.ovr_Achievements_GetDefinitionsByName(names, names != null ? names.Length : 0));
        ...
        public static Request<Models.AchievementProgressList> GetProgressByName(string[] names)
        {
            if (Core.IsInitialized())
                return new Request<Models.AchievementProgressList>(
                    CAPI.ovr_Achievements_GetProgressByName(names, names != null ? names.Length : 0));
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.AchievementUpdate>(CAPI.ovr_Achievements_Unlock(name));
    ...
    public static partial class Application
    {
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.ApplicationVersion>(CAPI.ovr_Application_GetVersion());
    ...
    public static partial class AssetFile
    {
        ...
        ///
        public static Request<Models.AssetFileDeleteResult> Delete(ulong assetFileID)
        {
            if (Core.IsInitialized())
        ...
        ///
        public static Request<Models.AssetFileDeleteResult> DeleteById(ulong assetFileID)
        {
            if (Core.IsInitialized())
        ...
        ///
        public static Request<Models.AssetFileDownloadResult> Download(ulong assetFileID)
        {
            if (Core.IsInitialized())
        ...
        /// \param assetFileID The asset file ID
        ///
        public static Request<Models.AssetFileDownloadResult> DownloadById(ulong assetFileID)
        {
            if (Core.IsInitialized())
        ...
        ///
        public static Request<Models.AssetFileDownloadCancelResult> DownloadCancel(ulong assetFileID)
        {
            if (Core.IsInitialized())
                return new Request<Models.AssetFileDownloadCancelResult>(
                    CAPI.ovr_AssetFile_DownloadCancel(assetFileID));
        ...
        /// \param assetFileID The asset file ID
        ///
        public static Request<Models.AssetFileDownloadCancelResult> DownloadCancelById(ulong assetFileID)
        {
            if (Core.IsInitialized())
                return new Request<Models.AssetFileDownloadCancelResult>(
                    CAPI.ovr_AssetFile_DownloadCancelById(assetFileID));
        ...
        public static Request<Models.AssetFileDownloadCancelResult> DownloadCancelByName(string assetFileName)
        {
            if (Core.IsInitialized())
                return new Request<Models.AssetFileDownloadCancelResult>(
                    CAPI.ovr_AssetFile_DownloadCancelByName(assetFileName));
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.AssetDetailsList>(CAPI.ovr_AssetFile_GetList());
        ...
        ///
        public static Request<Models.AssetDetails> Status(ulong assetFileID)
        {
            if (Core.IsInitialized()) return new Request<Models.AssetDetails>(CAPI.ovr_AssetFile_Status(assetFileID));
        ...
        /// \param assetFileID The asset file ID
        ///
        public static Request<Models.AssetDetails> StatusById(ulong assetFileID)
        {
            if (Core.IsInitialized())
        ...
        ///
        public static void SetDownloadUpdateNotificationCallback(
    ...
    public static partial class Challenges
    {
        ...
        {
            if (Core.IsInitialized())
                return new Request<Models.Challenge>(CAPI.ovr_Challenges_Create(leaderboardName,
        ...
        ///
        public static Request<Models.Challenge> DeclineInvite(ulong challengeID)
        {
            if (Core.IsInitialized())
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_Challenges_Delete(challengeID));
        ...
        ///
        public static Request<Models.Challenge> Get(ulong challengeID)
        {
            if (Core.IsInitialized()) return new Request<Models.Challenge>(CAPI.ovr_Challenges_Get(challengeID));
        ...
        ///
        public static Request<Models.ChallengeEntryList> GetEntries(ulong challengeID, int limit,
            LeaderboardFilterType filter, LeaderboardStartAt startAt)
        {
            if (Core.IsInitialized())
                return new Request<Models.ChallengeEntryList>(
                    CAPI.ovr_Challenges_GetEntries(challengeID, limit, filter, startAt));
        ...
        ///
        public static Request<Models.ChallengeEntryList> GetEntriesAfterRank(ulong challengeID, int limit,
            ulong afterRank)
        {
            if (Core.IsInitialized())
                return new Request<Models.ChallengeEntryList>(
                    CAPI.ovr_Challenges_GetEntriesAfterRank(challengeID, limit, afterRank));
        ...
        ///
        public static Request<Models.ChallengeEntryList> GetEntriesByIds(ulong challengeID, int limit,
            LeaderboardStartAt startAt, ulong[] userIDs)
        {
            if (Core.IsInitialized())
                return new Request<Models.ChallengeEntryList>(CAPI.ovr_Challenges_GetEntriesByIds(challengeID, limit,
                    startAt, userIDs, (uint)(userIDs != null ? userIDs.Length : 0)));
        ...
        ///
        public static Request<Models.Challenge> Join(ulong challengeID)
        {
            if (Core.IsInitialized()) return new Request<Models.Challenge>(CAPI.ovr_Challenges_Join(challengeID));
        ...
        ///
        public static Request<Models.Challenge> Leave(ulong challengeID)
        {
            if (Core.IsInitialized()) return new Request<Models.Challenge>(CAPI.ovr_Challenges_Leave(challengeID));
        ...
        ///
        public static Request<Models.Challenge> UpdateInfo(ulong challengeID, ChallengeOptions challengeOptions)
        {
            if (Core.IsInitialized())
                return new Request<Models.Challenge>(CAPI.ovr_Challenges_UpdateInfo(challengeID,
                    (IntPtr)challengeOptions));
    ...
    public static partial class CloudStorage
    {
        ...
        {
            if (Core.IsInitialized())
                return new Request<Models.CloudStorageConflictMetadata>(
                    CAPI.ovr_CloudStorage_LoadConflictMetadata(bucket, key));
        ...
        ///
        public static Request<Models.CloudStorageUpdateResponse> ResolveKeepLocal(string bucket, string key,
            string remoteHandle)
        {
            if (Core.IsInitialized())
                return new Request<Models.CloudStorageUpdateResponse>(
                    CAPI.ovr_CloudStorage_ResolveKeepLocal(bucket, key, remoteHandle));
        ...
        ///
        public static Request<Models.CloudStorageUpdateResponse> ResolveKeepRemote(string bucket, string key,
            string remoteHandle)
        {
            if (Core.IsInitialized())
                return new Request<Models.CloudStorageUpdateResponse>(
                    CAPI.ovr_CloudStorage_ResolveKeepRemote(bucket, key, remoteHandle));
        ...
        ///
        public static Request<Models.CloudStorageUpdateResponse> Save(string bucket, string key, byte[] data,
            long counter, string extraData)
        {
            if (Core.IsInitialized())
                return new Request<Models.CloudStorageUpdateResponse>(CAPI.ovr_CloudStorage_Save(bucket, key, data,
                    (uint)(data != null ? data.Length : 0), counter, extraData));
    ...
    public static partial class CloudStorage2
    {
        ...
        {
            if (Core.IsInitialized()) return new Request<string>(CAPI.ovr_CloudStorage2_GetUserDirectoryPath());
    ...
    public static partial class Entitlements
    {
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_Entitlement_GetIsViewerEntitled());
    ...
    public static partial class IAP
    {
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_IAP_ConsumePurchase(sku));
        ...
        {
            if (Core.IsInitialized())
                return new Request<Models.ProductList>(CAPI.ovr_IAP_GetProductsBySKU(skus,
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.PurchaseList>(CAPI.ovr_IAP_GetViewerPurchases());
    ...
    public static partial class LanguagePack
    {
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.AssetDetails>(CAPI.ovr_LanguagePack_GetCurrent());
    ...
    public static partial class Leaderboards
    {
        ...
        ///
        public static Request<Models.LeaderboardEntryList> GetEntries(string leaderboardName, int limit,
            LeaderboardFilterType filter, LeaderboardStartAt startAt)
        {
            if (Core.IsInitialized())
                return new Request<Models.LeaderboardEntryList>(
                    CAPI.ovr_Leaderboard_GetEntries(leaderboardName, limit, filter, startAt));
        ...
        ///
        public static Request<Models.LeaderboardEntryList> GetEntriesAfterRank(string leaderboardName, int limit,
            ulong afterRank)
        {
            if (Core.IsInitialized())
                return new Request<Models.LeaderboardEntryList>(
                    CAPI.ovr_Leaderboard_GetEntriesAfterRank(leaderboardName, limit, afterRank));
        ...
        /// \param userIDs Defines a list of user ids to get entries for.
        ///
        public static Request<Models.LeaderboardEntryList> GetEntriesByIds(string leaderboardName, int limit,
            LeaderboardStartAt startAt, ulong[] userIDs)
        {
            if (Core.IsInitialized())
                return new Request<Models.LeaderboardEntryList>(CAPI.ovr_Leaderboard_GetEntriesByIds(leaderboardName,
                    limit, startAt, userIDs, (uint)(userIDs != null ? userIDs.Length : 0)));
        ...
        ///
        public static Request<bool> WriteEntry(string leaderboardName, long score, byte[] extraData = null,
            bool forceUpdate = false)
        {
            if (Core.IsInitialized())
                return new Request<bool>(CAPI.ovr_Leaderboard_WriteEntry(leaderboardName, score, extraData,
        ...
        ///
        public static Request<bool> WriteEntryWithSupplementaryMetric(string leaderboardName, long score,
            long supplementaryMetric, byte[] extraData = null, bool forceUpdate = false)
        {
            if (Core.IsInitialized())
                return new Request<bool>(CAPI.ovr_Leaderboard_WriteEntryWithSupplementaryMetric(leaderboardName, score,
                    supplementaryMetric, extraData, (uint)(extraData != null ? extraData.Length : 0), forceUpdate));
    ...
    public static partial class Livestreaming
    {
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_Livestreaming_LaunchLivestreamingFlow());
    ...
    public static partial class Matchmaking
    {
        ...
        {
            if (Core.IsInitialized())
                return new Request<Models.MatchmakingBrowseResult>(CAPI.ovr_Matchmaking_Browse(pool,
                    customQueryData != null ? customQueryData.ToUnmanaged() : IntPtr.Zero));
        ...
        /// - \b 12072: Unknown pool: {pool_key}. You can configure matchmaking pools at https://dashboard.oculus.com/application/&lt;app_id&gt;/matchmaking
        ///
        public static Request<Models.MatchmakingBrowseResult> Browse2(string pool,
            MatchmakingOptions matchmakingOptions = null)
        {
            if (Core.IsInitialized())
                return new Request<Models.MatchmakingBrowseResult>(
                    CAPI.ovr_Matchmaking_Browse2(pool, (IntPtr)matchmakingOptions));
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_Matchmaking_Cancel(pool, requestHash));
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_Matchmaking_Cancel2());
        ...
        ///
        public static Request<Models.MatchmakingEnqueueResultAndRoom> CreateAndEnqueueRoom(string pool, uint maxUsers,
            bool subscribeToUpdates = false, CustomQuery customQueryData = null)
        {
            if (Core.IsInitialized())
                return new Request<Models.MatchmakingEnqueueResultAndRoom>(
                    CAPI.ovr_Matchmaking_CreateAndEnqueueRoom(pool, maxUsers, subscribeToUpdates,
                        customQueryData != null ? customQueryData.ToUnmanaged() : IntPtr.Zero));
        ...
        /// - \b 12089: You have asked to enqueue {num_users} users together, but this must be less than the maximum number of users in a room, {max_users}.
        ///
        public static Request<Models.MatchmakingEnqueueResultAndRoom> CreateAndEnqueueRoom2(string pool,
            MatchmakingOptions matchmakingOptions = null)
        {
            if (Core.IsInitialized())
                return new Request<Models.MatchmakingEnqueueResultAndRoom>(
                    CAPI.ovr_Matchmaking_CreateAndEnqueueRoom2(pool, (IntPtr)matchmakingOptions));
        ...
        {
            if (Core.IsInitialized())
                return new Request<Models.MatchmakingEnqueueResult>(CAPI.ovr_Matchmaking_Enqueue(pool,
                    customQueryData != null ? customQueryData.ToUnmanaged() : IntPtr.Zero));
        ...
        /// - \b 12072: Unknown pool: {pool_key}. You can configure matchmaking pools at https://dashboard.oculus.com/application/&lt;app_id&gt;/matchmaking
        ///
        public static Request<Models.MatchmakingEnqueueResult> Enqueue2(string pool,
            MatchmakingOptions matchmakingOptions = null)
        {
            if (Core.IsInitialized())
                return new Request<Models.MatchmakingEnqueueResult>(
                    CAPI.ovr_Matchmaking_Enqueue2(pool, (IntPtr)matchmakingOptions));
        ...
        /// - \b 12051: Pool '{pool_key}' is configured for Quickmatch mode. In Quickmatch mode, rooms are created on users' behalf when a match is found. Specify Advanced Quickmatch or Browse mode to use this feature.
        ///
        public static Request<Models.MatchmakingEnqueueResult> EnqueueRoom(ulong roomID,
            CustomQuery customQueryData = null)
        {
            if (Core.IsInitialized())
                return new Request<Models.MatchmakingEnqueueResult>(CAPI.ovr_Matchmaking_EnqueueRoom(roomID,
                    customQueryData != null ? customQueryData.ToUnmanaged() : IntPtr.Zero));
        ...
        /// - \b 12051: Pool '{pool_key}' is configured for Quickmatch mode. In Quickmatch mode, rooms are created on users' behalf when a match is found. Specify Advanced Quickmatch or Browse mode to use this feature.
        ///
        public static Request<Models.MatchmakingEnqueueResult> EnqueueRoom2(ulong roomID,
            MatchmakingOptions matchmakingOptions = null)
        {
            if (Core.IsInitialized())
                return new Request<Models.MatchmakingEnqueueResult>(
                    CAPI.ovr_Matchmaking_EnqueueRoom2(roomID, (IntPtr)matchmakingOptions));
        ...
        /// \param subscribeToUpdates If true, sends a message with type MessageType.Notification_Room_RoomUpdate when room data changes, such as when users join or leave.
        ///
        public static Request<Models.Room> JoinRoom(ulong roomID, bool subscribeToUpdates = false)
        {
            if (Core.IsInitialized())
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_Matchmaking_StartMatch(roomID));
    ...
    public static partial class Media
    {
        ...
        ///
        public static Request<Models.ShareMediaResult> ShareToFacebook(string postTextSuggestion, string filePath,
            MediaContentType contentType)
        {
            if (Core.IsInitialized())
                return new Request<Models.ShareMediaResult>(
                    CAPI.ovr_Media_ShareToFacebook(postTextSuggestion, filePath, contentType));
    ...
    public static partial class NetSync
    {
        ...
        ///
        public static void SetConnectionStatusChangedNotificationCallback(
            Message<Models.NetSyncConnection>.Callback callback)
        {
            Callback.SetNotificationCallback(
        ...
        ///
        public static void SetSessionsChangedNotificationCallback(
            Message<Models.NetSyncSessionsChangedNotification>.Callback callback)
        {
            Callback.SetNotificationCallback(
    ...
    public static partial class Notifications
    {
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_Notification_MarkAsRead(notificationID));
    ...
    public static partial class Parties
    {
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.Party>(CAPI.ovr_Party_GetCurrent());
    ...
    public static partial class RichPresence
    {
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_RichPresence_Clear());
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_RichPresence_Set((IntPtr)richPresenceOptions));
    ...
    public static partial class Rooms
    {
        ...
        /// \param subscribeToUpdates If true, sends a message with type MessageType.Notification_Room_RoomUpdate when room data changes, such as when users join or leave.
        ///
        public static Request<Models.Room> CreateAndJoinPrivate(RoomJoinPolicy joinPolicy, uint maxUsers,
            bool subscribeToUpdates = false)
        {
            if (Core.IsInitialized())
                return new Request<Models.Room>(
                    CAPI.ovr_Room_CreateAndJoinPrivate(joinPolicy, maxUsers, subscribeToUpdates));
        ...
        ///
        public static Request<Models.Room> CreateAndJoinPrivate2(RoomJoinPolicy joinPolicy, uint maxUsers,
            RoomOptions roomOptions)
        {
            if (Core.IsInitialized())
                return new Request<Models.Room>(
                    CAPI.ovr_Room_CreateAndJoinPrivate2(joinPolicy, maxUsers, (IntPtr)roomOptions));
        ...
        ///
        public static Request<Models.Room> Get(ulong roomID)
        {
            if (Core.IsInitialized()) return new Request<Models.Room>(CAPI.ovr_Room_Get(roomID));
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.Room>(CAPI.ovr_Room_GetCurrent());
        ...
        ///
        public static Request<Models.Room> GetCurrentForUser(ulong userID)
        {
            if (Core.IsInitialized()) return new Request<Models.Room>(CAPI.ovr_Room_GetCurrentForUser(userID));
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.UserList>(CAPI.ovr_Room_GetInvitableUsers());
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.RoomList>(CAPI.ovr_Room_GetModeratedRooms());
        ...
        ///
        public static Request<Models.Room> InviteUser(ulong roomID, string inviteToken)
        {
            if (Core.IsInitialized()) return new Request<Models.Room>(CAPI.ovr_Room_InviteUser(roomID, inviteToken));
        ...
        ///
        public static Request<Models.Room> Join(ulong roomID, bool subscribeToUpdates = false)
        {
            if (Core.IsInitialized()) return new Request<Models.Room>(CAPI.ovr_Room_Join(roomID, subscribeToUpdates));
        ...
        /// - \b 100: This game isn't available. If it already started or was canceled, you can host a new game at any point.
        ///
        public static Request<Models.Room> Join2(ulong roomID, RoomOptions roomOptions)
        {
            if (Core.IsInitialized()) return new Request<Models.Room>(CAPI.ovr_Room_Join2(roomID, (IntPtr)roomOptions));
        ...
        ///
        public static Request<Models.Room> KickUser(ulong roomID, ulong userID, int kickDurationSeconds)
        {
            if (Core.IsInitialized())
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_Room_LaunchInvitableUserFlow(roomID));
        ...
        ///
        public static Request<Models.Room> Leave(ulong roomID)
        {
            if (Core.IsInitialized()) return new Request<Models.Room>(CAPI.ovr_Room_Leave(roomID));
        ...
        /// - \b 10: Room {room_id}: The user does not have permission to {cannot_action} because the user is not the owner of the room.
        ///
        public static Request<Models.Room> SetDescription(ulong roomID, string description)
        {
            if (Core.IsInitialized())
        ...
        /// - \b 10: Room {room_id}: The user does not have permission to {cannot_action} because the user is not the owner of the room.
        ///
        public static Request<Models.Room> UpdateMembershipLockStatus(ulong roomID,
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_Room_UpdateOwner(roomID, userID));
        ...
        ///
        public static Request<Models.Room> UpdatePrivateRoomJoinPolicy(ulong roomID, RoomJoinPolicy newJoinPolicy)
        {
            if (Core.IsInitialized())
        ...
        /// Notifications.GetRoomInviteNotifications().
        ///
        public static void SetRoomInviteReceivedNotificationCallback(
            Message<Models.RoomInviteNotification>.Callback callback)
        {
            Callback.SetNotificationCallback(
    ...
    public static partial class Users
    {
        ...
        ///
        public static Request<Models.User> Get(ulong userID)
        {
            if (Core.IsInitialized()) return new Request<Models.User>(CAPI.ovr_User_Get(userID));
        ...
        {
            if (Core.IsInitialized()) return new Request<string>(CAPI.ovr_User_GetAccessToken());
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.User>(CAPI.ovr_User_GetLoggedInUser());
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.UserList>(CAPI.ovr_User_GetLoggedInUserFriends());
        ...
        ///
        public static Request<Models.UserAndRoomList> GetLoggedInUserRecentlyMetUsersAndRooms(
            UserOptions userOptions = null)
        {
            if (Core.IsInitialized())
                return new Request<Models.UserAndRoomList>(
                    CAPI.ovr_User_GetLoggedInUserRecentlyMetUsersAndRooms((IntPtr)userOptions));
        ...
        ///
        public static Request<Models.OrgScopedID> GetOrgScopedID(ulong userID)
        {
            if (Core.IsInitialized()) return new Request<Models.OrgScopedID>(CAPI.ovr_User_GetOrgScopedID(userID));
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.SdkAccountList>(CAPI.ovr_User_GetSdkAccounts());
        ...
        {
            if (Core.IsInitialized()) return new Request<Models.UserProof>(CAPI.ovr_User_GetUserProof());
        ...
        ///
        public static Request<Models.LaunchFriendRequestFlowResult> LaunchFriendRequestFlow(ulong userID)
        {
            if (Core.IsInitialized())
        ...
        {
            if (Core.IsInitialized()) return new Request(CAPI.ovr_User_LaunchProfile(userID));
    ...
    public static partial class UserDataStore
    {
        ...
        ///
        public static Request<Models.UserDataStoreUpdateResponse> PrivateDeleteEntryByKey(ulong userID, string key)
        {
            if (Core.IsInitialized())
                return new Request<Models.UserDataStoreUpdateResponse>(
                    CAPI.ovr_UserDataStore_PrivateDeleteEntryByKey(userID, key));
        ...
        {
            if (Core.IsInitialized())
                return new Request<Dictionary<string, string>>(
                    CAPI.ovr_UserDataStore_PrivateGetEntryByKey(userID, key));
        ...
        ///
        public static Request<Models.UserDataStoreUpdateResponse> PrivateWriteEntry(ulong userID, string key,
            string value)
        {
            if (Core.IsInitialized())
                return new Request<Models.UserDataStoreUpdateResponse>(
                    CAPI.ovr_UserDataStore_PrivateWriteEntry(userID, key, value));
        ...
        /// \param key The key of entry.
        ///
        public static Request<Models.UserDataStoreUpdateResponse> PublicDeleteEntryByKey(ulong userID, string key)
        {
            if (Core.IsInitialized())
                return new Request<Models.UserDataStoreUpdateResponse>(
                    CAPI.ovr_UserDataStore_PublicDeleteEntryByKey(userID, key));
        ...
        /// \param value The value of entry.
        ///
        public static Request<Models.UserDataStoreUpdateResponse> PublicWriteEntry(ulong userID, string key,
            string value)
        {
            if (Core.IsInitialized())
                return new Request<Models.UserDataStoreUpdateResponse>(
                    CAPI.ovr_UserDataStore_PublicWriteEntry(userID, key, value));
    ...
    public static partial class Achievements
    {
        public static Request<Models.AchievementDefinitionList> GetNextAchievementDefinitionListPage(
            Models.AchievementDefinitionList list)
        {
            if (!list.HasNextPage)
            {
        ...
        public static Request<Models.AchievementProgressList> GetNextAchievementProgressListPage(
            Models.AchievementProgressList list)
        {
            if (!list.HasNextPage)
            {
    ...
    public static partial class CloudStorage
    {
        public static Request<Models.CloudStorageMetadataList> GetNextCloudStorageMetadataListPage(
            Models.CloudStorageMetadataList list)
        {
            if (!list.HasNextPage)
            {
    ...
    public static partial class Notifications
    {
        public static Request<Models.RoomInviteNotificationList> GetNextRoomInviteNotificationListPage(
            Models.RoomInviteNotificationList list)
        {
            if (!list.HasNextPage)
            {
