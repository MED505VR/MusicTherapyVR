namespace Oculus.Platform
{
    ...
    public static class Callback
    {
        ...
        internal static void SetNotificationCallback<T>(Message.MessageType type, Message<T>.Callback callback)
        {
            ...
            if (type == Message.MessageType.Notification_Room_InviteAccepted) FlushRoomInviteNotificationQueue();
        }
        ...
        private sealed class RequestCallback<T> : RequestCallback
        {
            ...
            public override void HandleMessage(Message msg)
            {
                if (callback != null)
                {
                    ...
                    if (!hasRegisteredRoomInviteNotificationHandler &&
        ...
        internal static void HandleMessage(Message msg)
        {
            ...
            if (notificationCallbacks.TryGetValue(msg.Type, out callbackHolder)) callbackHolder.HandleMessage(msg);
        }
