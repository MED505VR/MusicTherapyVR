namespace Oculus.Platform.Samples.VrHoops
{
    ...
    public class LeaderboardManager
    {
        ...
        private void MostWinsGetEntriesCallback(Message<LeaderboardEntryList> msg)
        {
            ...
            if (m_mostWinsCallback != null) m_mostWinsCallback(m_mostWins);
            m_mostWins = null;
        }
        ...
        private void HighestScoreGetEntriesCallback(Message<LeaderboardEntryList> msg)
        {
            if (!msg.IsError)
            {
                foreach (var entry in msg.Data)
                {
                    ...
                    if (entry.User.ID == PlatformManager.MyID) m_foundLocalUserHighScore = true;
                }
            ...
            if (m_highScoreCallback != null) m_highScoreCallback(m_highScores);
            m_highScores = null;
        }
        ...
        public void SubmitMatchScores(bool wonMatch, uint score)
        {
            ...
            if (score > 0) Leaderboards.WriteEntry(HIGHEST_MATCH_SCORE, score);
        }
    }
}