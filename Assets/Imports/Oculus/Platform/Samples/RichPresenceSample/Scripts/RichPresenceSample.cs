   ...
   */
    ...
    */
    private void SetPresence()
    {
        ...
        if (!string.IsNullOrEmpty(DeeplinkMessageOverride)) options.SetDeeplinkMessageOverride(DeeplinkMessageOverride);

        if (!string.IsNullOrEmpty(InstanceID)) options.SetInstanceId(InstanceID);
   ...
   */
    ...
    private void ScrollThroughDestinations()
    {
        if (PressUp())
        {
            ...
            {
                DestinationIndex--;
                if (DestinationIndex < 0) DestinationIndex = DestinationAPINames.Count - 1;
                OnlyPushUpOnce = true;
                UpdateDestinationsConsole();
            }
        }
        else if (PressDown())
        {
            ...
            {
                DestinationIndex++;
                if (DestinationIndex >= DestinationAPINames.Count) DestinationIndex = 0;
                OnlyPushUpOnce = true;
                UpdateDestinationsConsole();
            }
        }
    ...
    private void UpdateDestinationsConsole()
    {
        ...
        var destinations = "Destination API Names:\n";
        for (var i = 0; i < DestinationAPINames.Count; i++)
        {
            if (i == DestinationIndex) destinations += "==>";
