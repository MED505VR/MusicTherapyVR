namespace Oculus.Platform.Samples.VrVoiceChat
{
    ...
    public class RoomManager
    {
        ...
        public ulong RemoteUserID => m_remoteUser != null ? m_remoteUser.ID : 0;

        public string RemoteOculusID => m_remoteUser != null ? m_remoteUser.OculusID : string.Empty;
        ...
        {
            var msg = (Message<RoomInviteNotificationList>)msg_untyped;
            ...
            foreach (var invite in msg.Data)
            {
        ...
        private void GetRoomInfoCallback(Message<Room> msg)
        {
            ...
            {
                var invite = new Invite(msg.Data.ID, msg.Data.OwnerOptional.OculusID);
                ...
                if (msg.Data.UsersOptional != null && msg.Data.UsersOptional.Count == 1) m_invites.Add(invite);
            }
        ...
        private void JoinRoomCallback(Message<Room> msg)
        {
            ...
            var oculusOwnerID = msg.Data.OwnerOptional != null ? msg.Data.OwnerOptional.OculusID : "";
