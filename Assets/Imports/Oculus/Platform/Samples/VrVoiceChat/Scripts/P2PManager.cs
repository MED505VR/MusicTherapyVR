namespace Oculus.Platform.Samples.VrVoiceChat
{
    ...
    public class P2PManager
    {
        ...
        public void ConnectTo(ulong userID)
        {
            ...
            if (PlatformManager.MyID < userID) Net.Connect(userID);
        }
        ...
        private void PeerConnectRequestCallback(Message<NetworkingPeer> msg)
        {
            ...
            if (msg.Data.ID == m_remoteID) Net.Accept(msg.Data.ID);
        }
        ...
        public bool ShouldSendHeadUpdate =>
            Time.time >= m_timeForNextUpdate && m_state == PeerConnectionState.Connected;
        ...
        public void GetRemoteHeadTransform(Transform headTransform)
        {
            ...
            var completed = Math.Min(Time.time - receivedTime, UPDATE_DELAY) / UPDATE_DELAY;
