...
namespace OculusSampleFramework
{
    ...
    public abstract class Interactable : MonoBehaviour
    {
        ...
        {
            if (ProximityZoneEvent != null) ProximityZoneEvent.Invoke(args);
        }
        ...
        {
            if (ContactZoneEvent != null) ContactZoneEvent.Invoke(args);
        }
        ...
        {
            if (ActionZoneEvent != null) ActionZoneEvent.Invoke(args);
        }
