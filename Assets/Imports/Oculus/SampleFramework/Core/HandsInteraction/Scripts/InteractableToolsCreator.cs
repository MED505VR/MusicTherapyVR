...
namespace OculusSampleFramework
{
    ...
    public class InteractableToolsCreator : MonoBehaviour
    {
        ...
        private IEnumerator AttachToolsToHands(Transform[] toolObjects, bool isRightHand)
        {
            ...
            foreach (var toolTransform in toolObjects) toolObjectSet.Add(toolTransform.transform);
            ...
            foreach (var toolObject in toolObjectSet)
            {
                ...
                while (handSkeletonToAttachTo == null || handSkeletonToAttachTo.Bones == null) yield return null;
