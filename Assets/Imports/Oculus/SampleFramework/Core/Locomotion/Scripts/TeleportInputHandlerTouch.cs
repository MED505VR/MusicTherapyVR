...
public class TeleportInputHandlerTouch : TeleportInputHandlerHMD
{
    ...
    {
        if (!isActiveAndEnabled) return LocomotionTeleport.TeleportIntentions.None;

        // If capacitive touch isn't being used, the base implementation will do the work.
        if (InputMode == InputModes.SeparateButtonsForAimAndTeleport) return base.GetIntention();
    ...
    public override void GetAimData(out Ray aimRay)
    {
        ...
        if (sourceController == OVRInput.Controller.Touch) sourceController = InitiatingController;
