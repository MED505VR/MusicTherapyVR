...
public class LocomotionTeleport : MonoBehaviour
{
    ...
    /// </summary>
    [NonSerialized] public TeleportAimHandler AimHandler;
    ...
    /// </summary>
    [NonSerialized] public TeleportInputHandler InputHandler;
    ...
    /// </summary>
    [NonSerialized] public TeleportIntentions CurrentIntention;
    ...
    /// </summary>
    [NonSerialized] public bool IsPreTeleportRequested;
    ...
    /// </summary>
    [NonSerialized] public bool IsPostTeleportRequested;
    ...
    {
        TeleportDestinationPrefab.gameObject
            .SetActive(false); // ensure the prefab isn't active in order to delay event handler setup until after it has been configured with a reference to this object.
    ...
    {
        if (oldDestination == _teleportDestination) CreateNewTeleportDestination();
    ...
    protected IEnumerator ReadyStateCoroutine()
    {
        ...
        if (EnterStateReady != null) EnterStateReady();

        // Wait until a teleport is requested.
        while (CurrentIntention != TeleportIntentions.Aim) yield return null;
    ...
    {
        if (UpdateAimData != null) UpdateAimData(aimData);
    }
    ...
    protected IEnumerator AimStateCoroutine()
    {
        ...
        if (EnterStateAim != null) EnterStateAim();
        ...
        if (ExitStateAim != null) ExitStateAim();
    ...
    protected IEnumerator CancelAimStateCoroutine()
    {
        ...
        if (EnterStateCancelAim != null) EnterStateCancelAim();
    ...
    protected IEnumerator PreTeleportStateCoroutine()
    {
        ...
        if (EnterStatePreTeleport != null) EnterStatePreTeleport();

        while (CurrentIntention == TeleportIntentions.PreTeleport || IsPreTeleportRequested) yield return null;
    ...
    protected IEnumerator CancelTeleportStateCoroutine()
    {
        ...
        if (EnterStateCancelTeleport != null) EnterStateCancelTeleport();
    ...
    protected IEnumerator TeleportingStateCoroutine()
    {
        ...
        if (EnterStateTeleporting != null) EnterStateTeleporting();
    ...
    protected IEnumerator PostTeleportStateCoroutine()
    {
        ...
        if (EnterStatePostTeleport != null) EnterStatePostTeleport();

        while (IsPostTeleportRequested) yield return null;
 ...
 destRotation * Quaternion.Euler(0, -LocomotionController.CameraRig.trackingSpace.localEulerAngles.y, 0);
#endif
        if (Teleported != null) Teleported(characterTransform, destPosition, destRotation);
    ...
    public Quaternion GetHeadRotationY()
    {
        ...
        if (device.isValid) device.TryGetFeatureValue(UnityEngine.XR.CommonUsages.deviceRotation, out headRotation);
