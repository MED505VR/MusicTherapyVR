...
public class TeleportDestination : MonoBehaviour
{
    ...
    public void OnEnable()
    {
        ...
        if (OrientationIndicator != null) OrientationIndicator.gameObject.SetActive(false);
        ...
        Quaternion? landingRotation)
    {
        ...
        {
            if (goActive) go.SetActive(false);
            return;
        }
        ...
        {
            if (rotation.HasValue) transform.rotation = rotation.GetValueOrDefault();
            return;
        }
        ...
        {
            if (ogoActive) orientationGO.SetActive(false);
            return;
        }

        OrientationIndicator.rotation = rotation.GetValueOrDefault();
        if (!ogoActive) orientationGO.SetActive(true);
    }
}