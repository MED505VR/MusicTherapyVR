...
public class TeleportAimHandlerParabolic : TeleportAimHandler
{
    ...
    /// </summary>
    [Tooltip("Maximum range for aiming.")] public float Range;
    ...
    /// </summary>
    [Tooltip("The AimVelocity is the initial speed of the faked projectile.")] [Range(0.001f, 50.0f)]
    public float AimVelocity = 1;

    /// <summary>
    /// The AimStep is the how much to subdivide the iteration.
    /// </summary>
    [Tooltip("The AimStep is the how much to subdivide the iteration.")] [Range(0.001f, 1.0f)]
