...
namespace OculusSampleFramework
{
    ...
    public class TrainButtonVisualController : MonoBehaviour
    {
        ...
        {
            if (_buttonMaterial != null) Destroy(_buttonMaterial);
        }
        ...
        {
            if (!_buttonInContactOrActionStates || collisionArgs.CollidingTool.IsFarFieldTool) return;
        ...
        {
            if (_lerpToOldPositionCr != null) StopCoroutine(_lerpToOldPositionCr);
        }

        private void LerpToOldPosition()
        {
            if ((transform.localPosition - _oldPosition).sqrMagnitude < Mathf.Epsilon) return;
