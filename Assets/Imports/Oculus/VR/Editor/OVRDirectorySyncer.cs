...
public class DirectorySyncer
{
    ...
    public abstract class CancellationToken
    {
        ...
        public virtual bool IsCancellationRequested => _IsCancellationRequested();

        public void ThrowIfCancellationRequested()
        {
            if (IsCancellationRequested) throw new Exception("Operation Cancelled");
        }
    ...
    public SyncResult Synchronize(CancellationToken cancellationToken)
    {
        ...
        if (WillPerformOperations != null) WillPerformOperations.Invoke(syncResult);
