...
public class OVRDisplay
{
    ...
    public void Update()
    {
        ...
        if (recenterRequested && Time.frameCount > recenterRequestedFrameCount)
        {
            ...
            if (RecenteredPose != null) RecenteredPose();
    ...
    {
#if USING_XR_SDK
        var currentInputSubsystem = OVRManager.GetCurrentInputSubsystem();
        if (currentInputSubsystem != null) currentInputSubsystem.TryRecenter();
