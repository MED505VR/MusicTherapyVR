...
public class OVRNetwork
{
    ...
    public class OVRNetworkTcpClient
    {
        ...
        private byte[][] receivedBuffers = { new byte[MaxBufferLength], new byte[MaxBufferLength] };
        ...
        public void Connect(int listeningPort)
        {
            if (tcpClient == null)
            {
                ...
                if (connectionStateChangedCallback != null) connectionStateChangedCallback();
            }
            else
            {
