...
public class OVRProfile : Object
{
    ...
    [System.Obsolete] public string id => "000abc123def";

    [System.Obsolete] public string userName => "Oculus User";

    [System.Obsolete] public string locale => "en_US";

    public float ipd =>
        Vector3.Distance(OVRPlugin.GetNodePose(OVRPlugin.Node.EyeLeft, OVRPlugin.Step.Render).ToOVRPose().position,
    ...
    [System.Obsolete] public State state => State.READY;
}