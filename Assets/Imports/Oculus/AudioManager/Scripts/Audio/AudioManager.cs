...
namespace OVR
{
    ...
    public class SoundGroup
    {
        ...
        [Range(0, 64)] public int maxPlayingSounds = 0; // default = 0, unlimited
    ...
    */
    public partial class AudioManager : MonoBehaviour
    {
        ...
        [Tooltip("Maximum sound emitters")] public int maxSoundEmitters = 32; // total number of sound emitters created
        ...
        [Tooltip("Sound FX fade time")] public float soundFxFadeSecs = 1.0f; // sound FX fade time
        ...
        public static bool enableSpatialization =>
            theAudioManager != null ? theAudioManager.enableSpatializedAudio : false;
        ...
        */
        private void Init()
        {
            ...
            {
                if (Application.isPlaying && theAudioManager != this) enabled = false;
                return;
            }
            ...
            if (Application.isPlaying)
            {
                ...
                if (makePersistent && transform.parent == null) // don't destroy the audio manager on scene loads
        ...
        private void RebuildSoundFXCache()
        {
            ...
            for (var group = 0; group < soundGroupings.Length; group++)
            {
                for (var i = 0; i < soundGroupings[group].soundList.Length; i++)
                    ...
                    {
                        Debug.LogError("ERROR: Duplicate Sound FX name in the audio manager: '" +
                                       soundGroupings[@group].name + "' > '" +
                                       soundGroupings[@group].soundList[i].name + "'");
                    }
                    else
                    {
...
#endif
            if (string.IsNullOrEmpty(name)) return nullSound;
            if (rebuildCache) theAudioManager.RebuildSoundFXCache();
