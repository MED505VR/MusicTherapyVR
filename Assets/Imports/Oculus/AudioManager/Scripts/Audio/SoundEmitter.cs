    ...
    public class SoundEmitter : MonoBehaviour
    {
        ...
        */
        private void Awake()
        {
            ...
            if (AudioManager.enableSpatialization && !disableSpatialization)
            {
                ...
                if (osp == null) osp = gameObject.AddComponent<ONSPAudioSource>();
            }
        ...
        */
        public void SetPlayingSoundGroup(SoundGroup soundGroup)
        {
            ...
            if (soundGroup != null) soundGroup.IncrementPlayCount();
        }
        ...
        */
        ...
        {
            if (audioSource != null) audioSource.outputAudioMixerGroup = _mixer;
        }
        ...
        */
        ...
        {
            if (loop && audioSource.isPlaying) return true;
        ...
        */
        public void FadeTo(float fadeTime, float toVolume)
        {
            ...
            if (state == FadeState.FadingOut) //Log.Print( "    ....ABORTED" );
                return;
        ...
        */
        public void FadeOut(float fadeTime)
        {
            ...
            if (!audioSource.isPlaying) //Log.Print( "   ... SKIPPING" );
                return;
        ...
        */
        ...
        {
            if (delaySecs > 0.0f) yield return new WaitForSeconds(delaySecs);
            ...
            if (fadeType == Fade.In)
            {
                if (Time.time == 0.0f) restartPlay = true;
                audioSource.volume = 0.0f;
                audioSource.Play();
            }
