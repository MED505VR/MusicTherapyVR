...
public class OvrAvatarSkinnedMeshRenderPBSComponent : OvrAvatarRenderComponent
{
    ...
    internal void Initialize(ovrAvatarRenderPart_SkinnedMeshRenderPBS skinnedMeshRenderPBS, Shader shader,
        int thirdPersonLayer, int firstPersonLayer)
    {
        if (shader == null) shader = Shader.Find("OvrAvatar/AvatarSurfaceShaderPBS");
        mesh = CreateSkinnedMesh(skinnedMeshRenderPBS.meshAssetID, skinnedMeshRenderPBS.visibilityMask,
            thirdPersonLayer, firstPersonLayer);
